...
<!-- [Optional] 🖼️ If this Pull Request makes visual changes then please include some screenshots that show what has changed here. A before and after screenshot helps the reviewer determine what changes were made. -->
...
Some examples:
- Enhanced platform performance using the realtime collaboration extension, especially on pages with numerous fields
- Restored site managers' ability to manage phase titles
- Fixed an issue with welcome messages in groups -->

## Issue tracker
<!-- [Required] Paste a link to the related Jira ticket. -->
<!-- [Optional] If any other issue trackers were used (like drupal.org), include links to those too. -->
